...
def BasicVSR(in_path, out_path, gpu, time_csv=None):
    ...
    run_docker("BasicVSR", "basicvsr", in_path, out_path, gpu, root=True, time_file=time_csv)
...
def RBPN(in_path, out_path, gpu, time_csv=None):
    ...
    run_docker("RBPN", "rbpn", in_path, out_path, gpu, root=True, time_file=time_csv)
...
def EGVSR(in_path, out_path, gpu, time_csv=None):
    ...
    run_docker("EGVSR", "egvsr", in_path, os.path.join(os.path.expanduser('~'), "__SR_models__/EGVSR/result"), gpu, root=True, time_file=time_csv)
